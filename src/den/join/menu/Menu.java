...
import den.join.menumode.LightDarkMode;
...
import den.join.menumode.ToolBarAccentColor;
...
public class Menu extends JPanel {
    ...
    private void init() {
        ...
        header.setIcon(new ImageIcon(getClass().getResource("/den/icon/png/logo.png")));
