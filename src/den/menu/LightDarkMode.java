...
public class LightDarkMode extends JPanel {
    ...
    private void init() {
        ...
        buttonLight = new JButton("Light", new FlatSVGIcon("den/menuicon/light.svg"));
        buttonDark = new JButton("Dark", new FlatSVGIcon("den/menuicon/dark.svg"));
    ...
    private void checkStyle() {
        ...
        if (isDark) {
            buttonLighDark.setIcon(new FlatSVGIcon("den/menuicon/dark.svg"));
        } else {
            buttonLighDark.setIcon(new FlatSVGIcon("den/menuicon/light.svg"));
        }
    }
